...
Clients SHOULD publish to at least three relays from a diverse set. The reference client uses `relay.ochk.io`, `nos.lol`, `relay.primal.net`, `offchain.pub`, `relay.damus.io`, `relay.snort.social`.
